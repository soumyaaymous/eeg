...
%% Load data
eeg = load('/home/soumyab/work/nexstem/organized_data/eyes_open_instinct_headset1/subject2/session2/data.csv');

%% Save as .set File
% Specify the file path to save the .set file
save_path = '/home/soumyab/work/nexstem/preprocessed_data/setFiles/raw'; % Replace with your desired save location
...
nexEEG.chanlocs = struct( ...
    ...
    'impedances', {0, 86.72, 665.08, 33.54, 78.30, 824.44, 104.89, 18.46, 106.83, 50.76, 20.55, ...
                   ...
                   68.71, 287.13, 23253.53, 135189.57, 0}, ... % Impedance values in kΩ
